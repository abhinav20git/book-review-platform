...
const ProfilePage = () => {
    ...
    const fetchUserReviews = useCallback(async () => {
        try {
            ...
            const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/users/profile/reviews/paginate?page=${page}&limit=3`, {
                headers: {
    ...
    const handleSearch = async (e) => {
        ...
        try {
            ...
            const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/users/profile/reviews/search?query=${searchQuery}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const handleDelete = async (reviewId) => {
        ...
        try {
            ...
            await axios.delete(`${process.env.REACT_APP_BASE_URL}/api/reviews/${reviewId}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
